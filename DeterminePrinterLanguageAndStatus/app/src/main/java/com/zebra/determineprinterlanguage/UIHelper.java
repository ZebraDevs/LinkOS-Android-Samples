    ...
    public void showLoading(final String message) {
        ...
        if (activity != null) {
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    AlertDialog.Builder builder=new  AlertDialog.Builder(activity,R.style.ButtonAppearance);
        ...
        if (activity != null) {
            activity.runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    loadingDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "OK", new DialogInterface.OnClickListener() {
