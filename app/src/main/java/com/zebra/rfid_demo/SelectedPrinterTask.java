...
public class SelectedPrinterTask extends AsyncTask<Void, Boolean, Boolean> {
    ...
    protected Boolean doInBackground(Void... params) {
        ...
        try {
            ...
            SelectedPrinterManager.setSelectedPrinter(selectedPrinter);
    ...
    protected void onPostExecute(Boolean populateBluetoothDiscoDataSuccessful) {
        ...
        if (populateBluetoothDiscoDataSuccessful) {
            ...
            mainActivity.showSnackbar(mainActivity.getString(R.string.printer_connected));
        } else {
            mainActivity.resetConnectingStatus();
            mainActivity.showSnackbar(mainActivity.getString(R.string.printer_connection_failed));
        }
    }
}
