...
public class MainActivity extends DatabaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView newEntryButton = (TextView) findViewById(R.id.button_scan);
        newEntryButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.i(NEW_ENTRY_TAG, "New Entry button clicked");

                // Launch one of the new entry activities
                finish();
                Intent intent;
                intent = new Intent(MainActivity.this, NewScanLabelActivity.class);
